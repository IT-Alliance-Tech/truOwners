    ...
    try {
      ...
      if (!response.ok) {
        ...
        const specificError =
          typeof data.error === "object"
            ...
            : data.error;
        throw new Error(specificError || errorMessage);
      }
      ...
      if (data.success) {
        ...
        if (typeof login !== "function") {
          ...
          console.error(
            "  - AuthContext not properly connected in signup flow"
          );
          throw new Error(
            "Authentication system error. Please refresh and try again."
          );
        }
        ...
        try {
          ...
          setTimeout(() => {
            ...
            if (!storedToken || !storedUser) {
              console.error(
                "❌ OTP: Data not stored in localStorage after login!"
              );
      ...
      <div className="auth-modal">
              ...
              <div>
                ...
                {retryCount > 2 && (
                  <div className="error-help">
                    <small>
                      Still having trouble? Try requesting a new code.
                    </small>
                  </div>
                )}
              </div>
        ...
        <div className="auth-footer">
          <p>
            ...
            <button
              className={`auth-link ${
                resendCooldown > 0 || loading ? "disabled" : ""
              }`}

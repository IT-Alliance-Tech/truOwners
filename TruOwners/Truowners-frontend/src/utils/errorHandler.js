...
export const getErrorMessage = (data) => {
  // If we have a structured error object (our new standard)
  if (data.error) {
    if (typeof data.error === "object") {
      // Return details if available (for technical errors like Gmail config), else message
      return data.error.details || data.error.message || "An error occurred";
    }
    return data.error;
  }
